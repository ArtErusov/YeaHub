   ...
   return (
      ...
      >
         <svg className={styles['burger-button__svg']} width="30" height="30" viewBox="0 0 100 100">
            <path
               className={clsx(styles['burger-button__line'], styles['burger-button__line--1'])}
            ...
            />
            <path
               className={clsx(styles['burger-button__line'], styles['burger-button__line--2'])}
               d="M 20,50 H 80"
            />
            <path
               className={clsx(styles['burger-button__line'], styles['burger-button__line--3'])}
